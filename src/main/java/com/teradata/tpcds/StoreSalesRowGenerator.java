...
import static com.teradata.tpcds.StoreSalesColumn.SR_IS_RETURNED;
import static com.teradata.tpcds.StoreSalesColumn.SS_NULLS;
import static com.teradata.tpcds.StoreSalesColumn.SS_PERMUTATION;
        ...
        implements RowGenerator
{
    ...
    public RowGeneratorResult generateRowAndChildRows(long rowNumber, Session session)
    {
        ...
        if (randomInt < SR_RETURN_PCT && (!session.hasTable() || session.getTable() != STORE_SALES)) {
