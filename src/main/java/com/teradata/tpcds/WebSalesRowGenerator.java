...
import static com.teradata.tpcds.WebSalesColumn.WR_IS_RETURNED;
...
import static com.teradata.tpcds.WebSalesColumn.WS_NULLS;
import static com.teradata.tpcds.WebSalesColumn.WS_ORDER_NUMBER;
import static com.teradata.tpcds.WebSalesColumn.WS_PERMUTATION;
        ...
        implements RowGenerator
{
    ...
    public RowGeneratorResult generateRowAndChildRows(long rowNumber, Session session)
    {
        ...
        if (randomInt < RETURN_PERCENTAGE && (!session.hasTable() || !(session.getTable() == WEB_SALES))) {
